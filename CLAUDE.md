...
For explicit MASTER_PLAN/phase work only, read `agent/MASTER_PLAN.md`, `AUDIT.md`, `phase-logs/index.json`, then `tips/phases/00-phase-index.md`, then the active `tips/phases/*.md` phase file. Log explicit phase work in `tips/phases/logs/` and update `phase-logs/`.

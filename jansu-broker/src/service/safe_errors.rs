...
use jansu_service::{FrameRequestLayer, FrameRouteBuilder, ResponseService};
use rama::{
...
safe_error_route!(
    describe_log_dirs,
    jansu_sans_io::DescribeLogDirsRequest,
    _req,
    jansu_sans_io::DescribeLogDirsResponse,
    {
        jansu_sans_io::DescribeLogDirsResponse::default()
            .throttle_time_ms(0)

...
use jansu_service::{BytesFrameLayer, BytesFrameService, FrameRouteService};
use jansu_storage::{
...
async fn auth_handshake_scram_256_v1() -> Result<()> {
    ...
    let broker = jansu_auth::configuration(engine.clone())
        .map_err(Into::into)
        .map(Some)
...
impl Storage for Engine {
    ...
    ) -> jansu_storage::Result<()> {
        unimplemented!()
    }

    #[instrument(skip_all)]
    async fn brokers(&self) -> jansu_storage::Result<Vec<DescribeClusterBroker>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<DeleteRecordsTopicResult>> {
        unimplemented!()
    }

    #[instrument(skip_all)]
    async fn delete_topic(&self, _topic: &TopicId) -> jansu_storage::Result<ErrorCode> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<AlterConfigsResourceResponse> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<Batch>> {
        unimplemented!()
    }

    #[instrument(skip_all)]
    async fn offset_stage(&self, _topition: &Topition) -> jansu_storage::Result<OffsetStage> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<(Topition, ErrorCode)>> {
        unimplemented!()
    }
    ...
    async fn committed_offset_topitions(
        &self,
        _group_id: &str,
    ) -> jansu_storage::Result<BTreeMap<Topition, i64>> {
        unimplemented!()
    }
    ...
    async fn offset_for_leader_epoch(
        ...
        _topition: &Topition,
        _leader_epoch: i32,
    ) -> jansu_storage::Result<Option<(i32, i64)>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<(Topition, ListOffsetResponse)>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<MetadataResponse> {
        unimplemented!()
    }
    ...
    async fn describe_config(
        ...
        _keys: Option<&[String]>,
    ) -> jansu_storage::Result<DescribeConfigsResult> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<DescribeTopicPartitionsResponseTopic>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<ListedGroup>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<DeletableGroupResult>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<NamedGroupDetail>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Version, UpdateError<GroupDetail>> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<ProducerIdResponse> {
        unimplemented!()
    }
    ...
    async fn txn_add_offsets(
        ...
        _producer_epoch: i16,
        _group_id: &str,
    ) -> jansu_storage::Result<ErrorCode> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<TxnAddPartitionsResponse> {
        unimplemented!()
    }
    ...
    ) -> jansu_storage::Result<Vec<TxnOffsetCommitResponseTopic>> {
        unimplemented!()
    }
    ...
    #[instrument(skip_all)]
    async fn maintain(&self, _now: SystemTime) -> jansu_storage::Result<()> {
        unimplemented!()
    }

    #[instrument(skip_all)]
    async fn cluster_id(&self) -> jansu_storage::Result<String> {
        unimplemented!()
    }

    #[instrument(skip_all)]
    async fn node(&self) -> jansu_storage::Result<i32> {
        unimplemented!()
    }

    #[instrument(skip_all)]
    async fn advertised_listener(&self) -> jansu_storage::Result<Url> {
        unimplemented!()
    }

    #[instrument(skip_all)]
    async fn ping(&self) -> jansu_storage::Result<()> {
        unimplemented!()
    }
    ...
    async fn user_scram_credential(
        ...
        user: &str,
        mechanism: ScramMechanism,
    ) -> jansu_storage::Result<Option<ScramCredential>> {

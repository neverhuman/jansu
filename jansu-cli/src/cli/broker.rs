...
use clap::Parser;
use jansu_broker::{NODE_ID, broker::Broker, coordinator::group::administrator::Controller};
use jansu_sans_io::ErrorCode;
use jansu_schema::Registry;
use jansu_storage::{ArcDynStorage, StorageContainer};
...
pub(super) struct Arg {
    ...
    /// Schema registry examples are: file://./etc/schema or s3://jansu/, containing: topic.json, topic.proto or topic.avsc
...
pub(super) enum Lake {
    ...
    Iceberg {
        ...
        /// Iceberg namespace
        #[arg(long, env = "ICEBERG_NAMESPACE", default_value = "jansu")]
    ...
    Delta {
        ...
        /// Delta database
        #[arg(long, env = "DELTA_DATABASE", default_value = "jansu")]

...
use jansu_otel::meter_provider;
use jansu_sans_io::{
    ByteSize, ErrorCode, ProduceRequest,
    produce_request::{PartitionProduceData, TopicProduceData},
    record::{deflated, inflated},
};
use jansu_schema::{Generator as _, Registry, Schema};
...
impl From<jansu_schema::Error> for Error {
    fn from(error: jansu_schema::Error) -> Self {

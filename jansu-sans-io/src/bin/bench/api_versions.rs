...
use bytes::Bytes;
use jansu_sans_io::{ApiKey, ApiVersionsResponse};

use super::{Codec, CodecRequest, CodecResponse};

pub(super) fn api_versions_request_v0_000() -> Codec {
    CodecRequest {
...
pub(super) fn api_versions_request_v3_000() -> Codec {
    CodecRequest {
        expected: Bytes::from_static(&[
...
pub(super) fn api_versions_response_v1_000() -> Codec {
    CodecResponse {
        expected: Bytes::from_static(&[
...
pub(super) fn api_versions_response_v3_000() -> Codec {
    CodecResponse {
        expected: Bytes::from_static(&[

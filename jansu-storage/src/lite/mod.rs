...
mod lite_timestamp;
pub(super) use lite_timestamp::LiteTimestamp;
...
impl Storage for Delegate {
    ...
    async fn produce(
        ...
        self.delegate_produce(transaction_id, topition, deflated).await
    }
    ...
    async fn fetch(
        ...
        self.delegate_fetch(topition, offset, min_bytes, max_bytes, isolation_level).await
    }
    ...
    async fn offset_fetch_records(
        ...
        self.delegate_offset_fetch_records(group_id, topics, require_stable).await
    }
    ...
    async fn offset_for_leader_epoch(
        ...
        self.delegate_offset_for_leader_epoch(topition, leader_epoch).await
    }
    ...
    async fn offset_fetch(
        ...
        self.delegate_offset_fetch(group_id, topics, require_stable).await
    }
    ...
    async fn describe_topic_partitions(
        ...
        self.delegate_describe_topic_partitions(topics, partition_limit, cursor).await
    }
    ...
    async fn describe_groups(
        ...
        self.delegate_describe_groups(group_ids, include_authorized_operations).await
    }
    ...
    async fn init_producer(
        ...
        self.delegate_init_producer(transaction_id, transaction_timeout_ms, producer_id, producer_epoch).await
    }
    ...
    async fn txn_add_offsets(
        ...
        self.delegate_txn_add_offsets(transaction_id, producer_id, producer_epoch, group_id).await
    }
    ...
    async fn txn_end(
        ...
        self.delegate_txn_end(transaction_id, producer_id, producer_epoch, committed).await
    }
    ...
    async fn delete_user_scram_credential(
        ...
        self.delegate_delete_user_scram_credential(user, mechanism).await
    }
    ...
    async fn upsert_user_scram_credential(
        ...
        self.delegate_upsert_user_scram_credential(user, mechanism, credential).await
    }

...
//! Transaction query helpers: tx_prepare_execute, tx_prepare_query, tx_prepare_query_raw

use super::*;

impl Postgres {
    #[instrument(skip(self, tx, params))]
    pub(super) async fn tx_prepare_execute(
        &self,
        tx: &Transaction<'_>,
        sql: &str,
    ...
    #[instrument(skip(self, tx, params))]
    pub(super) async fn tx_prepare_query(
        &self,
        tx: &Transaction<'_>,
        sql: &str,
        params: &[&(dyn ToSql + Sync)],
    ...
    #[instrument(skip(self, tx, params))]
    pub(super) async fn tx_prepare_query_one(
        &self,
        tx: &Transaction<'_>,
        sql: &str,
        params: &[&(dyn ToSql + Sync)],
    ...
    #[instrument(skip(self, tx, params))]
    pub(super) async fn tx_prepare_query_opt(
        &self,
        tx: &Transaction<'_>,
        sql: &str,
        params: &[&(dyn ToSql + Sync)],
    ...
    #[instrument(skip(self, tx, params))]
    pub(super) async fn tx_prepare_query_raw<P, I>(
        &self,
        tx: &Transaction<'_>,
        sql: &str,
        params: I,

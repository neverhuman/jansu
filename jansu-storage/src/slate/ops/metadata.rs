...
//! Metadata and configuration description operations for the SlateDB engine.

use std::iter;

use jansu_sans_io::{
    ConfigResource, ConfigSource, ErrorCode, NULL_TOPIC_ID,
...
use crate::{MetadataResponse, Result, TopicId, Topition};

use super::super::engine::Engine;
use super::super::types::TopicMetadata;

impl Engine {
    pub(in crate::slate) async fn metadata_op(
        &self,
    ...
    pub(in crate::slate) async fn describe_config_op(
        &self,
        name: &str,
    ...
    pub(in crate::slate) async fn describe_topic_partitions_op(
        &self,
        topics: Option<&[TopicId]>,
        partition_limit: i32,

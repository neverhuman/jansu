...
//! Producer initialization and transactional offset registration for the SlateDB engine.
...
use super::super::types::{
    BatchKey, Producers, Transactions, Txn, TxnDetail, Watermark, WatermarkKey,
};

impl Engine {
    pub(in crate::slate) async fn init_producer_op(
        &self,
        ...
        if let Some(transaction_id) = transaction_id {
            ...
            let mut pd = super::super::types::ProducerDetail::default();
    ...
    pub(in crate::slate) async fn txn_add_offsets_op(
        &self,
        _transaction_id: &str,
        _producer_id: i64,
        _producer_epoch: i16,
